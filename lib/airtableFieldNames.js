...
/** Donate form donation type → display label (folded into existing Airtable text fields) */
export function donationTypeLabel(value) {
  const map = {
    drive: 'Drive Donation',
    instrument: 'Instrument Donation',
  }
  return value ? map[value] || value : ''
}
